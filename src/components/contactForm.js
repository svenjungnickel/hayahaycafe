...
export default () => {
    ...
    let successAlertStyle = [Styles.contactFormSuccess];
    let contactFormStyle = [Styles.contactForm];
    if (true === success) {
        successAlertStyle.push(Styles.contactFormSuccessShow);
        contactFormStyle.push(Styles.contactFormHide);
    }
    ...
    return (
        <>
            <Form
                ...
                className={contactFormStyle.join(' ')}
            >
            ...
            <Alert variant="success" className={successAlertStyle.join(' ')}>
